...
public class Orologio {
	...
	} //fine metodo costruttore Orologio(int hours, int minutes)
	...
	} //fine metodo costruttore Orologio(int hours, int minutes, int seconds)
	
	private void setNumeroSeriale() {
		count++;
		numeroSeriale = count;
	}
	...
	} //fine metodo setSeconds(int seconds)
	...
	private int getHour() {
		...
		public String getNumeroSeriale() {
			...
			seriale = "#000" +numeroSeriale;
			
			return seriale;
			
		} //fine metodo getNumeroSeriale()
